...
exports.withRequestOrigin = exports.withRequestOriginPropTypes = void 0;
...
var withRequestOriginPropTypes = {
  requestOrigin: _propTypes.default.string.isRequired
};
exports.withRequestOriginPropTypes = withRequestOriginPropTypes;

var withRequestOrigin = function withRequestOrigin(Page) {
  ...
  function (_Component) {
    ...
    _createClass(WithRequestOrigin, [{
      ...
      value: function render() {
        return _react.default.createElement(Page, this.props);
      }
    }], [{
      key: "getInitialProps",
  ...
  WithRequestOrigin.displayName = "WithRequestOrigin(".concat((0, _componentDisplayName.default)(Page), ")");
  return WithRequestOrigin;
};
