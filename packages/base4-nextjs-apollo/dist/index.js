...
var _regenerator = interopRequireDefault(regenerator$1);
...
unwrapExports(utils);
var utils_1 = utils.execOnce;
var utils_2 = utils.getDisplayName;
var utils_3 = utils.isResSent;
var utils_4 = utils.loadGetInitialProps;
var utils_5 = utils.getLocationOrigin;
var utils_6 = utils.getURL;

var sideEffect = createCommonjsModule(function (module, exports) {
...
var _set = interopRequireDefault(set$2);
...
function withSideEffect(reduceComponentsToState, handleStateChangeOnClient, mapStateOnServer) {
  ...
  return function wrap(WrappedComponent) {
    ...
    (0, _defineProperty2.default)(SideEffect, "displayName", "SideEffect(".concat((0, utils.getDisplayName)(WrappedComponent), ")"));
    return SideEffect;
  };
}
});

unwrapExports(sideEffect);
...
var _sideEffect = interopRequireDefault(sideEffect);
...
var wrap$3 = require('optimism').wrap;
...
var create$2 = function create(apolloConfig, initialState) {
...
function initApollo(config, initialState, req) {
  ...
  if (!process.browser) {
    return create$2(apolloConfig, initialState, req);
  } // Reuse the same client instance.


  if (!apolloClient) {
    apolloClient = create$2(apolloConfig, initialState);
  }
