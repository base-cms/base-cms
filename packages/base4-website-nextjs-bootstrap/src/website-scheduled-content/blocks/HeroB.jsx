...
import { CardBodyD, ListGroupA } from '../../content';
        ...
        return (
          <div className="row">
            <div className="col-lg-7 col-xl-8">
              <Card>
                <CardBodyD content={content} {...attrs} />
              </Card>
            </div>
...
BlockHeroB.propTypes = propTypes;
BlockHeroB.defaultProps = defaultProps;

export default BlockHeroB;
