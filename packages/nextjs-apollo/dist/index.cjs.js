...
var introspectionQueryResultData = _interopDefault(require('@base-cms/graphql-fragment-types'));
...
var create = function create(apolloConfig, initialState) {
  ...
  return new apolloClient.ApolloClient(config);
};
...
function initApollo(config, initialState, req) {
  ...
  if (!apolloClient$1) {
    apolloClient$1 = create(apolloConfig, initialState);
  }
