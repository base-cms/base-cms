...
module.exports = cleanEnv(process.env, {
  ...
  RECAPTCHA_SITE_KEY: str({ desc: 'An site key for sending recaptcha validation.', default: '6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI' }),
  RECAPTCHA_SECRET_KEY: str({ desc: 'A secret key for sending recaptcha validation.', default: '6LeIxAcTAAAAAGG-vFI1TnRWxMZNFuojJ4WifJWe' }),
