...
interface Content @requiresProject(fields: ["type"]) {
  ...
  # GraphQL-only fields.
  metadata: ContentMetadata! @projection(localField: "type", needs: ["name", "mutations.Website.name", "mutations.Website.seoTitle", "mutations.Website.primarySection", "company", "teaser", "mutations.Website.teaser"])
